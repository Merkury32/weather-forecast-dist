...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppDailyDailyComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DailyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 22,
      vars: 5,
      consts: [[1, "current-weather-div"], [1, "current-location-header"], [1, "current-time-header"], [1, "current-temperature-header"], [1, "current-feelsTemperature-header"], [1, "current-line-breaker"], [1, "current-weather-header"], [1, "daily-weather-div"], ["class", "daily-one-day-div", 4, "ngFor", "ngForOf"], [1, "daily-one-day-div-last"], [1, "daily-one-day-div"]],
      template: function DailyComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](19, "20\xB0/10\xB0");
